...
namespace Managers.UI
{
    class PanelEstacao : PanelManager
    {
        ...
        public void Abrir(int id_estacao_tipo)
        {
            ...
            switch (id_estacao_tipo)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    nome.text = "Pesquisa Nv. " + ScoreManager.instance.GetEstacaoPorTipo(id_estacao_tipo).nivel.ToString();
                    estacaoAgua.SetActive(false);
                    estacaoFazenda.SetActive(false);
            ...
            if (pop != null)
            {
                pop.PreencherMelhorias(id_estacao_tipo);
            }
